...
import com.panton.domain.{Email, Id, Name, Password, User}
import com.panton.repository._
import com.panton.domain.errors.{RegErrors, SpecificError, SuchUserAlreadyExist, SuchUserDoesNotExist}
import com.panton.service.domain.RegistrationValidator
